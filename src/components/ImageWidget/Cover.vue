...
.image {
  ...
  .dj {
    ...
    .needle {
      ...
      border-radius: 50%;
      box-shadow:
        inset -2px 0px 5px 0px #494646,
        inset -4px 0px 6px 0px #494646;
      &::after {
        content: '';
        width: 20px;
        cursor: grabbing;
      ...
      &::before {
        ...
        // top:-20px;
        // right: 2px;
        transform: translateX(-70px) perspective(200px) translateY(-29px) translateZ(50px)
          rotate(60deg);
      }
    }
    // &:hover{
  ...
  center {
    ...
    height: 20px;
    box-shadow:
      inset 0px 0px 0px 10px rgb(152, 221, 152),
    ...
    .dj {
      ...
      .needle {
        ...
        &::before {
          ...
          // top:-20px;
          // right: 2px;
          transform: translateX(-20px) perspective(200px) translateY(-10px) translateZ(50px)
            rotate(60deg);
        }
      }
      // &:hover{
