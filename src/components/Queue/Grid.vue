<template>
  <div class="container">
    <center>Your WishList ({{ listTrack.length }}) songs</center>

    <div class="grid">
      <div
        @click="this.$emit('gridPlay', [a, index])"
        class="tile"
        v-for="(a, index) in listTrack"
        :key="index"
      >
        <img :src="a.artwork" />
        <button class="play">
    ...
    <button class="btn" @click="this.$emit('closeQueue')">
      <b class="material-icons mi-close"></b>
    </button>
  </div>
</template>
